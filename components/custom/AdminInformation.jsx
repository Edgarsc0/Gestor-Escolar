...
import { User, Mail, Phone, MapPin, Lock, AlertCircle, Loader2, ShieldCheck, Shield } from "lucide-react"
...
export default function AdminInformation() {
    ...
    useEffect(() => {
        if (user) {
            setIdentityData({ fullName: user.full_name })
            
            const fetchPersonalInfo = async () => {
                setIsLoading(true)
                try {
                    const res = await fetch(`/api/personal_info/${user.id}`)
                    if (res.ok) {
    ...
    const handleSaveChanges = async () => {
        ...
        setIsSaving(true)
        try {
            const payload = { ...contactInfo, ...addressInfo }
            ...
            if (res.ok) {
                setIsModified(false)
                setSuccessMessage("La información de perfil ha sido actualizada correctamente.")
            ...
            <div className="max-w-4xl mx-auto space-y-6 p-6">
                ...
                <Card className="border-slate-200 shadow-sm bg-white">
                    ...
                    <CardContent className="space-y-6 pt-6">
                        ...
                        <Alert className="bg-blue-50 border-blue-100 text-blue-800">
                            ...
                            <AlertDescription>
                                Tu rol de Administrador te permite acceso total al sistema.
                            </AlertDescription>
                        </Alert>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-200 shadow-sm bg-white">
                    ...
                    <CardContent className="pt-6">
                        <EmergencyContactsManager userId={effectiveUserId} />
                    </CardContent>
                </Card>
                    ...
                    <CardHeader className="border-b border-slate-100 pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>Medios de contacto personal</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6 pt-6">
                ...
                <Card className="border-slate-200 shadow-sm bg-white">
                    <CardHeader className="border-b border-slate-100 pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-base font-medium text-slate-900">Dirección</CardTitle>
                                <CardDescription>Información de domicilio</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6 pt-6">
